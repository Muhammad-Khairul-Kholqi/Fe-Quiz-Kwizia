    ...
    <div class="w-full">
        ...
        <div class="relative">
            <textarea :id="inputId" :value="modelValue" @input="$emit('update:modelValue', $event.target.value)"
                ...
                class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg outline-none transition-all resize-y disabled:bg-gray-100 disabled:cursor-not-allowed"
                :class="{
